...
namespace MongoDB.Bson.Serialization.Serializers
{
    ...
    /// </summary>
    public class BsonValueSerializer : BsonBaseSerializer<BsonValue>
    {
        ...
        /// <param name="actualType">The actual type of the object (ignored).</param>
        /// <returns>An object.</returns>
        public override BsonValue Deserialize(DeserializationContext context)
        {
        ...
        public override void Serialize(SerializationContext context, BsonValue value)
        {
            if (value == null)
            {
            ...
            switch (value.BsonType)
            {
                ...
                case BsonType.Document:
                    ...
                    if (wrapper != null)
                    {
                        context.SerializeWithChildContext(wrapper.Serializer, wrapper.Wrapped);
                    }
                    else
                    {
                        BsonDocumentSerializer.Instance.Serialize(context, (BsonDocument)value); break;
                    }
                    break;
