...
{
    [TestFixture]
    public class ShardedSingleServerClusterTests
    {
        ...
        public void Setup()
        {
            ...
            _subject = new SingleServerCluster(new ClusterSettings(ClusterType.Sharded, new [] { _server.DnsEndPoint }, null), serverFactory);
            _subject.Initialize();
        }
        ...
        public void Description_should_be_updated_when_the_server_is_connected()
        {
            ...
            Assert.AreEqual(ServerType.ShardRouter, description.Servers.Single().Type);
        }
