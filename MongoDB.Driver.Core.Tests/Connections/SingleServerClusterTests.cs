...
namespace MongoDB.Driver.Core.Connections
{
    ...
    public class SingleServerClusterTests
    {
        ...
        public void Setup()
        {
            ...
            _subject = new SingleServerCluster(_server.DnsEndPoint, serverFactory);
        }
        ...
        public void Description_should_return_a_cluster_description_of_type_Multi()
        {
            ...
            Assert.AreEqual(ClusterDescriptionType.Single, description.Type);
        }
        ...
        public void SelectServer_should_throw_an_exception_if_it_does_not_match_and_already_connected()
        {
            ...
            var selector = new DelegateServerSelector("never", s => false);
