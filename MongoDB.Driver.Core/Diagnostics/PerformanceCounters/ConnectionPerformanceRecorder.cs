...
namespace MongoDB.Driver.Core.Diagnostics.PerformanceCounters
{
    internal class ConnectionPerformanceRecorder 
    {
        ...
        public void MessageSent(int requestId, int sizeInBytes)
        {
            ...
            _appPackage.AverageSizeOfSentMessagesInBytes.IncrementBy(sizeInBytes);
            _appPackage.AverageSizeOfSentMessagesInBytesBase.IncrementBy(100);
            _serverPackage.AverageSizeOfSentMessagesInBytes.IncrementBy(sizeInBytes);
