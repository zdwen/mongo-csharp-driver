...
namespace MongoDB.Driver.GeoJsonObjectModel.Serializers
{
    ...
    public class GeoJsonLineStringCoordinatesSerializer<TCoordinates> : BsonBaseSerializer<GeoJsonLineStringCoordinates<TCoordinates>> where TCoordinates : GeoJsonCoordinates
    {
        ...
        public override GeoJsonLineStringCoordinates<TCoordinates> Deserialize(DeserializationContext context)
        {
        ...
        public override void Serialize(SerializationContext context, GeoJsonLineStringCoordinates<TCoordinates> value)
        {
