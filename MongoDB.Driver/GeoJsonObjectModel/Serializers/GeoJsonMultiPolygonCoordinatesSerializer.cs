...
namespace MongoDB.Driver.GeoJsonObjectModel.Serializers
{
    ...
    public class GeoJsonMultiPolygonCoordinatesSerializer<TCoordinates> : BsonBaseSerializer<GeoJsonMultiPolygonCoordinates<TCoordinates>> where TCoordinates : GeoJsonCoordinates
    {
        ...
        public override GeoJsonMultiPolygonCoordinates<TCoordinates> Deserialize(DeserializationContext context)
        {
        ...
        public override void Serialize(SerializationContext context, GeoJsonMultiPolygonCoordinates<TCoordinates> value)
        {
